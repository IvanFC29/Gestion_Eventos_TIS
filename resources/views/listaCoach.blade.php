...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha384-HjQE9FzIlI9tLvBzmgfM3KlI1i47HEqx4vBUby8C+9T1yt9uV1Qs1we3EeT2Sl1r" crossorigin="anonymous">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="container mt-4 ">
                <div id="contenido">
                    ...
                    <div>
                        <h2 class="titulo-grande">Lista de Coachs</h2>
                    </div>
                    <br>
                    <br>
                    <form action="{{ route('coachs.filtrar') }}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <tbody>
                            @foreach ($coachs as $coach)
                                <tr>
                                    ...
                                    <td>{{ $coach->name }}</td>
                                    <td>{{ $coach->apellidoP }}</td>
                                    
                                    <td>{{ $coach->apellidoM }}</td>
