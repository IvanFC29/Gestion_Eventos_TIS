...
<form method="post" action="{{ route('eventos.guardarEvento') }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="fechaEventoInicio" class="form-control" id="fechaevento" min="<?php echo date('Y-m-d'); ?>">
    </div>
    <div class="mb-3">
        <label>Fecha de culminación:<span class="date-danger">*</span></label>
        <input type="date" name="fechaEventoFin" class="form-control" id="fechaevento" min="<?php echo date('Y-m-d'); ?>">
    </div>
    <div class="mb-3">
