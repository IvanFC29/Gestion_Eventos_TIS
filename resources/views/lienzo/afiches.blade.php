                ...
                <div class="row">
                    <div id="plantilla" class="col-md-4">
                        <div class="card eventocard">
                            ...
                            <div class="card-body eventobodycard">
                                <a href="/canvas_new_version" type="button" class="btn btn-color" title="Hoja en Blanco">
                    ...
                    <div id="plantilla" class="col-md-4">
                        <div class="card eventocard">
                            ...
                            <div class="card-body eventobodycard">
                                <a href="{{ route('canvas', ['image' => 'afiche3.jpg']) }}" type="button" class="btn btn-color" title="Hoja con tonos aqua">
                                    Seleccionar plantilla
                                </a>
                            </div>        
                        </div>         
                    ...
                    <div id="plantilla" class="col-md-4">
                        <div class="card eventocard">
                            ...
                            <div class="card-body eventobodycard">
                                <a href="{{ route('canvas', ['image' => 'afiche2.jpg']) }}" type="button" class="btn btn-color" title="Hoja con diseño ICPC clasico">
                                    Seleccionar plantilla
                                </a>
                            </div>        
                        </div>         
